                                    ...
                                    <table class="table">
                                        ...
                                        <?php $__currentLoopData = $commissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <?php else: ?>
                                                    <td><?php echo e(( $commission->amount)); ?>% (<?php echo e(\Auth::user()->priceFormat($commission->tota_allow)); ?>)</td>
                                                <?php endif; ?>
                                                <?php if(\Auth::user()->type != 'Employee'): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/accufy_erp/public/resources/views/setsalary/employee_salary.blade.php ENDPATH**/ ?>