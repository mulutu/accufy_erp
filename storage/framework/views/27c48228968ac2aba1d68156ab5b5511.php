                    ...
                    <div class="d-flex gap-3 mt-4 banner-btn">
                        ...
                        <?php if($settings['home_buy_now_link']): ?>
                            <a href="<?php echo e($settings['home_buy_now_link']); ?>"
                                class="btn btn-outline-dark"><?php echo e(__('Register Now for FREE')); ?> <i data-feather="lock"
                                    class="ms-2"></i></a>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\accufy_erp\public\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>