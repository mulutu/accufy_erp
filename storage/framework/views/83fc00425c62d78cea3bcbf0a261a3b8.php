                ...
                <?php $__currentLoopData = $incomeChartAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $chartAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php $__currentLoopData = $incomeSubAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($key == $subAccount['account']): ?>
                            <option value="<?php echo e($subAccount['id']); ?>" class="ms-5" <?php echo e(($productService->sale_chartaccount_id == $subAccount['id']) ? 'selected' : ''); ?>> &nbsp; &nbsp;&nbsp; <?php echo e(isset($subAccount['code_name']) ? $subAccount['code_name'] : ''); ?></option>
                        <?php endif; ?>
        ...
        <div class="col-md-6 form-group">
            ...
            <div class="choose-file ">
                ...
                <p id="" class="file-error text-danger"></p>
                    ...
                    <img id="image" class="mt-3" width="100" src="<?php echo e($productService->pro_image ? \App\Models\Utility::get_file('uploads/pro_image/'.$productService->pro_image) : asset(Storage::url('uploads/pro_image/user-2_1654779769.jpg'))); ?>" />
                </label>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\accufy_erp\public\resources\views/productservice/edit.blade.php ENDPATH**/ ?>