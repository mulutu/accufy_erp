                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo Form::text('national_id_number', old('national_id_number'), [
                                            'class' => 'form-control',
                                            'required' => 'required',
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo Form::text('revenue_authority_number', old('revenue_authority_number'), [
                                            'class' => 'form-control',
                                            'required' => 'required',
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo Form::text('social_security_number', old('social_security_number'), [
                                            'class' => 'form-control',
                                            'required' => 'required',
                                    ...
                                    <div class="form-group col-md-6">
                                        <?php echo Form::label('health_insurance_number', __('NHIF Number'), ['class' => 'form-label']); ?><span class="text-danger pl-1">*</span>
                                        <?php echo Form::text('health_insurance_number', old('health_insurance_number'), [
                                            'class' => 'form-control',
                                            'required' => 'required',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\accufy_erp\public\resources\views/employee/create.blade.php ENDPATH**/ ?>