...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <a href="#" data-size="lg" data-url="<?php echo e(route('productservice.create')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" data-title="<?php echo e(__('Create New Product & Service')); ?>" class="btn btn-sm btn-primary">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\accufy_erp\public\resources\views/productservice/index.blade.php ENDPATH**/ ?>