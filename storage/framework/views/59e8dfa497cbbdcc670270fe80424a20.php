        ...
        <div class="me-auto dash-mob-drp">
            <ul class="list-unstyled">
                ...
                <div class="col d-flex align-items-center page-header-title dropdown dash-h-item drp-company">
                    <h4 class="breadcrumb-item"><?php echo $__env->yieldContent('page-title'); ?>&nbsp;&nbsp;</h4>
...
<?php /**PATH C:\xampp\htdocs\accufy_erp\public\resources\views/partials/admin/header.blade.php ENDPATH**/ ?>