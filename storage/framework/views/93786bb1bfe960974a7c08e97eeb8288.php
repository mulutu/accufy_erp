                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row d-flex align-items-center justify-content-center">
                                                ...
                                                <div class="col d-flex flex-column justify-content-center ">
                                                    <p class="text-muted text-sm m-0 p-0 text-left "><?php echo e(__('Total')); ?></p>
                                                    <h6 class="text-left"><?php echo e(__('Customers')); ?></h6>
                                                </div>
                                                <div class="col d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row d-flex align-items-center justify-content-center">
                                                ...
                                                <div class="col d-flex flex-column justify-content-center ">
                                                    <p class="text-muted text-sm m-0 p-0 text-left "><?php echo e(__('Total')); ?></p>
                                                    <h6 class="text-left"><?php echo e(__('Vendors')); ?></h6>
                                                </div>
                                                <div class="col d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row d-flex align-items-center justify-content-center">
                                                ...
                                                <div class="col d-flex flex-column justify-content-center ">
                                                    <p class="text-muted text-sm m-0 p-0 text-left "><?php echo e(__('Total')); ?></p>
                                                    <h6 class="text-left"><?php echo e(__('Bills')); ?></h6>
                                                </div>
                                                <div class="col d-flex justify-content-center align-items-center">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\accufy_erp\public\resources\views/dashboard/account-dashboard.blade.php ENDPATH**/ ?>