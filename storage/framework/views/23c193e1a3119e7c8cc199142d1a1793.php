...
<?php if(isset($settings['recaptcha_module']) && $settings['recaptcha_module'] == 'on'): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/accufy_erp/public/resources/views/auth/register.blade.php ENDPATH**/ ?>