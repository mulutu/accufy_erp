                ...
                <div class="col-xl-3">
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <a href="#google-analytics-settings"
                                class="list-group-item list-group-item-action border-0"><?php echo e(__('Google Analytics Settings')); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="google-analytics-settings" class="card">
                        <div class="card-header">
                            <h5><?php echo e(__('Google Analytics Settings')); ?></h5>
                        </div>
                        <?php echo e(Form::model($settings, ['route' => 'googleanalytics.settings', 'method' => 'post'])); ?>

                        <div class="card-body">
                            <div class="row">
                                <div class="form-group ">
                                    <?php echo e(Form::label('google_analytics_code', __('Google Analytics Code'), ['class' => ' form-label'])); ?>

                                    <?php echo Form::textarea('google_analytics_code', isset($settings['google_analytics_code']) ? $settings['google_analytics_code'] : '', [
                                        'class' => 'form-control cookie_setting ',
                                        'rows' => '3',
                                    ]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\accufy_erp\public\resources\views/settings/index.blade.php ENDPATH**/ ?>