                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row d-flex align-items-center justify-content-center">
                                                ...
                                                <div class="col d-flex flex-column justify-content-center ">
                                                    <p class="text-muted text-sm m-0 p-0 text-left ">{{ __('Total') }}</p>
                                                    <h6 class="text-left">{{ __('Customers') }}</h6>
                                                </div>
                                                <div class="col d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row d-flex align-items-center justify-content-center">
                                                ...
                                                <div class="col d-flex flex-column justify-content-center ">
                                                    <p class="text-muted text-sm m-0 p-0 text-left ">{{ __('Total') }}</p>
                                                    <h6 class="text-left">{{ __('Vendors') }}</h6>
                                                </div>
                                                <div class="col d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row d-flex align-items-center justify-content-center">
                                                ...
                                                <div class="col d-flex flex-column justify-content-center ">
                                                    <p class="text-muted text-sm m-0 p-0 text-left ">{{ __('Total') }}</p>
                                                    <h6 class="text-left">{{ __('Bills') }}</h6>
                                                </div>
                                                <div class="col d-flex justify-content-center align-items-center">
